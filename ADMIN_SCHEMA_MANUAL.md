...
## ระบบขออนุมัติเข้าใช้ห้องปฏิบัติการสาขาวิชาวิศวกรรมโยธานอกเวลาปฏิบัติงาน (CE F.A.I.R.)
...
ระบบ **CE F.A.I.R.** พัฒนาขึ้นเพื่อจัดการคำขอเข้าใช้งานห้องปฏิบัติการนอกเวลาทำการ (จันทร์-ศุกร์ 16.30-20.30 น. และเสาร์-อาทิตย์ 08.30-16.30 น.) แบบไร้กระดาษ 100% พร้อมระบบวิเคราะห์ความปลอดภัยด้วย AI และผสานการทำงานกับ Google Sheets, Google Calendar และระบบควบคุมการเข้า-ออกประตู (Access Control).
...
| 15 | `AllowedTimeStart`| String | เวลาเริ่มต้นที่อนุญาต เช่น `16:30` |
| 16 | `AllowedTimeEnd` | String | เวลาสิ้นสุดที่อนุญาต เช่น `20:30` |
